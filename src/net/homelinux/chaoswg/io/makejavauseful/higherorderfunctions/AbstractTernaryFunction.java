...
public abstract class AbstractTernaryFunction<R, I0, I1, I2> implements TernaryFunction<R, I0, I1, I2> {
    public BinaryFunction<R, I1, I2> curry(final I0 arg0) {
        final TernaryFunction<R, I0, I1, I2> thisOne = this;
        
        final BinaryFunction<R, I1, I2> toReturn = new AbstractBinaryFunction<R, I1, I2> () {
            public final R apply (final I1 arg1, final I2 arg2) {
                return thisOne.apply(arg0, arg1, arg2);
            }
        };
        return toReturn;
    }
    ...
    public UnaryFunction<R, I2> curry(final I0 arg0, final I1 arg1) {
        ...
        final UnaryFunction<R, I2> toReturn = new AbstractUnaryFunction<R, I2> () {
            public final R apply (final I2 arg2) {
                return thisOne.apply(arg0, arg1, arg2);
            }
        };
        return toReturn;
    ...
    public List<R> mapcar(final List<? extends I0> list0, final List<? extends I1> list1, final List<? extends I2> list2) {
        ...
        while (iter0.hasNext() && iter1.hasNext() && iter2.hasNext()) {
            toReturn.add (this.apply(iter0.next(), iter1.next(), iter2.next()));
        }
    ...
    public List<R> mapcar(final I0[] array0, final I1[] array1, final I2[] array2) {
        return this.mapcar(Arrays.asList(array0), Arrays.asList(array1), Arrays.asList(array2));
    }
